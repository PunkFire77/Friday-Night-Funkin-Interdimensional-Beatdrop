...
idleOffsets = {'-6', '-1'}        -- I recommend you have your idle offset at 0
leftOffsets = {'45', '-36'}
downOffsets = {'-6', '-75'}
upOffsets = {'-60', '17'}
rightOffsets = {'-49', '-7'}

leftMissOffsets = {'35', '-18'}    -- use as required
downMissOffsets = {'-42', '-44'}
upMissOffsets = {'-60', '55'}
rightMissOffsets = {'-80', '22'}

-- change all of these to the name of the animation in your character's xml file including the leading 0. Caps Sensitive.
idle_xml_name = 'GF Idle dance0'
left_xml_name = 'GF Left0'
down_xml_name = 'GF Down0'
up_xml_name = 'GF Up0'
right_xml_name = 'GF Right0'

left_miss_xml_name = 'GF Miss Left0'   -- use as required
down_miss_xml_name = 'GF Miss Down0'
up_miss_xml_name = 'GF Miss Up0'
right_miss_xml_name = 'GF Miss Right0'
...
name_of_character_xml = 'Playable GF V2'
name_of_character = 'Playable GF V2'
charNote = 'Playable GF V2'
